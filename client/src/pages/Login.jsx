      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          <div style={{
            ...
            opacity: mounted ? 1 : 0,
            transform: mounted ? 'translateY(0)' : 'translateY(12px)',
            transition: 'all 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.65s',
          }}>
            <a
              href="/api/google-oauth/login"
              onMouseOver={() => setHoverBtn('google')}
              onMouseOut={() => setHoverBtn(null)}
              style={{
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px',
                width: '100%', padding: '12px',
                background: hoverBtn === 'google' ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.03)',
                border: `1px solid ${hoverBtn === 'google' ? 'rgba(255,255,255,0.15)' : 'rgba(255,255,255,0.08)'}`,
                borderRadius: '10px',
                fontSize: '14px', fontWeight: '500', color: '#E4E4E7',
                textDecoration: 'none', boxSizing: 'border-box',
                cursor: 'pointer',
                transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                boxShadow: hoverBtn === 'google' ? '0 0 20px rgba(255,255,255,0.03)' : 'none',
              }}
            >
